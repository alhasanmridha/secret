...
public abstract class JingleDescription implements ExtensionElement {
    ...
    public static class WebRTCSDP extends JingleDescription {

        public static final String NAMESPACE = "urn:xmpp:jingle:apps:sdp";
        private String sdp;
         ...
         * Utility constructor, with a PayloadType.
         */
        public WebRTCSDP(final String nsdp) {
            super();
            sdp=nsdp;
        }
    ...
    public static class WebRTCCandidate extends JingleDescription {

        public static final String NAMESPACE = "urn:xmpp:jingle:transports:candidates";
         ...
         * Utility constructor, with a PayloadType.
         */
        public WebRTCCandidate(final String ncandidate) {
            super();
