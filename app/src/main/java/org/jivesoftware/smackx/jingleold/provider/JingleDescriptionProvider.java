...
public abstract class JingleDescriptionProvider extends ExtensionElementProvider<JingleDescription> {
    ...
    public static class WebRTCSDP extends JingleDescriptionProvider {
        ...
        @Override
        protected JingleDescription getInstance() {
            return new JingleDescription.WebRTCSDP();
        }
    }

    public static class WebRTCCandidate extends JingleDescriptionProvider {
        ...
        @Override
        protected JingleDescription getInstance() {
            return new JingleDescription.WebRTCCandidate();
        }
    }
